# adapters/inbound/desktop_ui/add_player_dialog.py
# Migrated Add Player dialog (UI-3)

from __future__ import annotations

from PySide6.QtWidgets import QDialog, QHBoxLayout, QLabel, QLineEdit, QPushButton, QSpinBox, QVBoxLayout, QWidget
