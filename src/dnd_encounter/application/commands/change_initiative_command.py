...
class ChangeInitiativeCommand(BaseCommand):
    ...
    def execute(self) -> None:
        ...
        self.publisher.publish(
            "initiative_changed", {"instance_id": self.instance_id, "old_initiative": self._old_initiative, "new_initiative": self.new_initiative}
        )
    ...
    def undo(self) -> None:
        ...
        self.publisher.publish(
            "initiative_changed", {"instance_id": self.instance_id, "old_initiative": self.new_initiative, "new_initiative": self._old_initiative}
        )
